class MOE_CraftExplosiveMilitary : RecipeBase
{	
	override void Init()
	{
		//m_Name = "Craft Military Explosive";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"MOE_C4_Stick");//you can insert multiple ingredients this way
		...
		//result1
		string resultType = "MOE_Explosive_Military";
		AddResult(resultType);//add results here
		m_Name = string.Format("#STR_MOE_Craft_Explosive_Military [%1]", MiscGameplayFunctions.GetItemDisplayName(resultType));
